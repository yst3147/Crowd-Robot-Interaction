...
def main():
    ...
    for i, log_file in enumerate(args.log_files):
        ...
        for r in re.findall(val_pattern, log):
            while int(r[0]) < 5000:
                continue
            val_episode.append(int(r[0]) - 5000)
        ...
        for r in re.findall(train_pattern, log):
            while count < 5000:
                continue
            train_episode.append(count - 5000)
        ...
        if args.plot_sr:
            ...
            if args.plot_train:
                ...
                ax1_legends.append(models[i] + '_train')
            if args.plot_val:
                ax1.plot(val_episode, val_sr)
                ax1_legends.append(models[i] + '_val')
        ...
        if args.plot_time:
            ...
            if args.plot_train:
                ...
                ax2_legends.append(models[i] + '_train')
            if args.plot_val:
                ax2.plot(val_episode, val_time)
                ax2_legends.append(models[i] + '_val')
        ...
        if args.plot_cr:
            ...
            if args.plot_train:
                ...
                ax3_legends.append(models[i] + '_train')
            if args.plot_val:
                ax3.plot(val_episode, val_cr)
                ax3_legends.append(models[i] + '_val')
        ...
        if args.plot_reward:
            ...
            if args.plot_train:
                ...
                ax4_legends.append(models[i] + '_train')
            if args.plot_val:
                ax4.plot(val_episode, val_reward)
                ax4_legends.append(models[i] + '_val')
